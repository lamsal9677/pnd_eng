                ...
                <div>
                    <section className="services-details">
                        <div className="auto-container">
                            ...
                            <h2>Retaining Wall Designs</h2>
                            </div>
                            <div className="row">
                                <div className="col-lg-8 content-side">
                                    {/*Theme Carousel*/}
                                    <AuditSlider1 src={"/assets/myImages/sources/Retaining Wall.jpeg"} />
                                        ...
                                        <div className="widget widget_categories_two">
                                            <div className="widget-content">
                                                <ul className="categories-list clearfix">
                                                    ...
                                                    <li className='active'><Link style={{color:"#7dafc3"}} href="/retaining-wall">Retaining Wall Designs<span /></Link></li>
