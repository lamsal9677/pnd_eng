                        ...
                        <div className="auto-container">
                            ...
                            <div className="row">
                                <div className="col-lg-8 content-side">
                                    {/*Theme Carousel*/}
                                    <AuditSlider1 src={"/assets/myImages/sources/Commercial Design.jpeg"} />
                                        ...
                                        <div className="widget widget_categories_two">
                                            <div className="widget-content">
                                                <ul className="categories-list clearfix">
                                                    ...
                                                    <li className='active'><Link style={{color:"#7dafc3"}} href="/commercial-designs">Commercial Designs <span /></Link></li>
