...
export default function ServiceTabs1() {
    ...
    return (
        ...
        <div className="blog-single-post">
            <h3 className="title custom-title">Single Family Residential New Construction: Crafting Your Dream Home</h3>
                ...
                <div className="col-md-7">
                    ...
                    <div className="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                        ...
                        <div className={activeIndex == 7 ? "tab-pane fadeInUp animated show active" : "tab-pane fadeInUp animated"}>
                            <h4 className='custom-title'>Your Dream Home Awaits</h4>
                            <div className="text  text-align">
                            At P&D Engineering Solutions LLC, we are passionate about turning dreams into
