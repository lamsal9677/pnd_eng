import ServiceTab from "app/single-family/ServiceTabs.js"
                                        ...
                                        <div className="widget widget_categories_two">
                                            <div className="widget-content">
                                                <ul className="categories-list clearfix">
                                                    ...
                                                    <li className='active'><Link style={{color:"#7dafc3"}}  href="/single-family">Single Family Residental <br/> Structures<span /></Link></li>
