                ...
                <div>
                    <section className="services-details">
                        <div className="auto-container">
                            ...
                            <h2>Structural Evaluations and Reports</h2>
                            </div>
                            <div className="row">
                                <div className="col-lg-8 content-side">
                                    {/*Theme Carousel*/}
                                    <AuditSlider1 src={"/assets/myImages/sources/somewhere.jpeg"} />
                                        ...
                                        <div className="widget widget_categories_two">
                                            <div className="widget-content">
                                                <ul className="categories-list clearfix">
                                                    ...
                                                    <li className='active'><Link style={{color:"#7dafc3"}} href="/structural-evaluations">Structural Evaluations and <br/>Reports <span /></Link></li>
